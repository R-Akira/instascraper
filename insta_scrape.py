...
def recent_post_links(username, post_count=10):
    ...
    browser = Firefox(executable_path =r'/Users/Akira/Desktop/WebScrapperrrrr/geckodriver.exe',firefox_options=firefox_options)
    browser.get(url)
    post = 'https://www.instagram.com/p/'
    post_links = []
    while len(post_links) < post_count:
        b = browser.find_elements_by_xpath('//*[@id="react-root"]/section/main/div/div[3]/article/div[1]/div')
...
def insta_link_details(url):
    ...
    try:
        ...
        likes = browser.find_element_by_xpath(
            """//*[@id="react-root"]/section/main/div/div[1]/article/div/div[3]/section[2]/div/div/button/span""").text.split()[0]
        post_type = 'photo'

    except:
        # This captures the like count for videos which is stored
        likes = browser.find_element_by_xpath(
            """//*[@id="react-root"]/section/main/div/div[1]/article/div/div[3]/section[2]/div/span/span""").text.split()[0]
        post_type = 'video'

    age = browser.find_element_by_css_selector('a time').text
    try:
        comment = browser.find_element_by_xpath("""//*[@id="react-root"]/section/main/div/div[1]/article/div/div[3]/div[1]/ul/div/li/div/div/div[2]/span""").text
    except:
        comment = "no_caption"
